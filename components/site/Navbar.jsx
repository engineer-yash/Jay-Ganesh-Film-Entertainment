...
export default function Navbar() {
  ...
  const SocialIcons = ({ size = 'md' }) => (
    <div className="flex items-center gap-2">
      <a href={site.socials.instagram} target="_blank" rel="noreferrer" aria-label="Instagram" className={socialLinkClass}>
        <Instagram className="h-4 w-4" />
      </a>
      <a href={site.socials.youtube} target="_blank" rel="noreferrer" aria-label="YouTube" className={socialLinkClass}>
        <Youtube className="h-4 w-4" />
      </a>
      <a href={site.socials.facebook} target="_blank" rel="noreferrer" aria-label="Facebook" className={socialLinkClass}>
        <Facebook className="h-4 w-4" />
      </a>
      <a href={site.socials.whatsapp} target="_blank" rel="noreferrer" aria-label="WhatsApp" className={socialLinkClass}>
    ...
    <header className={cn(
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
        ...
        <div className="hidden md:flex items-center gap-3">
          <SocialIcons />
          <Link href="/contact" className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-full bg-primary text-primary-foreground hover:bg-primary/90 transition">
            Join a Class
          </Link>
        </div>
      ...
      {open && (
        <div className="md:hidden border-t border-border/60 bg-background/95 backdrop-blur-xl">
          <div className="px-4 py-4 flex flex-col gap-1">
            ...
            {/* Join a Class below icons */}
            <Link
              href="/contact"
              className="mt-3 text-center px-4 py-3 rounded-full bg-primary text-primary-foreground font-semibold"
            >
              Join a Class
            </Link>
          </div>
