...
export const metadata = {
  ...
  description: 'Tandav Dance Competition, Shubh Garba Raas Dandiya and Glamour Gateway — three unforgettable stages by Jay Ganesh Films Entertainment.',
};
    ...
    <div className="pt-28 pb-24">
      ...
      <section className="mt-8 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <Reveal delay={0.1}><h1 className="font-display text-5xl md:text-7xl mt-4 leading-[1.02]">Three stages. <span className="text-gradient-gold">Unforgettable nights.</span></h1></Reveal>
